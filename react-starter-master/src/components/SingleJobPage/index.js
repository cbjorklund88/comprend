  ...
  render() {
    ...
    return (
      <div className="wrapper">
        ...
        You will work in our agile web team, closely with our UX designers and Back-End Developers and together create solutions, that pushes the visual limits.</blockquote>
        <div className="single-job-description-container">
          ...
          <div>
            ...
            Most of all, we believe that you have an eye for details, are curious and open minded, want to learn and develop while also being humble, self-going and responsible.</p>
            </div>
          </div>
        ...
        Comprend also offers great possibilities for flexible working; from home, a coffee shop or why not from our office in London.</p>
        ...
        Our reality means we need to constantly change the way we think and work on our development. We are eager to learn from each other's experiences and to follow what goes on in the world outside Comprend. We have a flat organisation, an open climate and we'd love to hear about your crazy ideas!</p>

        <h2>Apply below and we&apos;ll get in touch with you for a face to face meet!</h2>
